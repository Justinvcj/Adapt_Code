...
PROBLEMS = [
    ...
    },
    {
        ...
        "description": "Return the factorial of N using a loop. Read from input (one value per line or space-separated based on standard convention) and print the result.",
        "concept_tag": "loops",
        "difficulty_level": "medium",
    ...
    },
    {
        ...
        "description": "Given an integer n > 1, print True if it is a prime number, else False. Read from input (one value per line or space-separated based on standard convention) and print the result.",
        "concept_tag": "loops",
        "difficulty_level": "medium",
    ...
    {
        "title": "Sum of Array",
        "description": "Given a list of numbers, return their sum. Read from input (one value per line or space-separated based on standard convention) and print the result.",
        "concept_tag": "arrays",
        "difficulty_level": "easy",
        "hint_text": "Iterate through the array or use built-in sum() after parsing the input.",
        "solution_code": "import json\n\narr = json.loads(input())\nprint(sum(arr))",
        "solution_explanation": "Read the JSON array input using json.loads(), then compute and print its sum using Python's built-in sum() function.",
        "test_cases": [
            {
                "input": "[1, 2, 3]",
                "expected_output": "6"
    ...
    {
        "title": "Find Maximum",
        "description": "Given a list of numbers, print the maximum element. Read from input (one value per line or space-separated based on standard convention) and print the result.",
        "concept_tag": "arrays",
        "difficulty_level": "easy",
        "hint_text": "Use input().split() to parse the space-separated numbers, convert them to integers, and find the maximum using max().",
        "solution_code": "numbers = list(map(int, input().split()))\nprint(max(numbers))",
        "solution_explanation": "Read the space-separated numbers from standard input, convert them to integers, and print the maximum value using Python's built-in max() function.",
        "test_cases": [
            {
                "input": "1 5 3",
                "expected_output": "5"
    ...
    {
        "title": "Reverse Array",
        "description": "Given a list, return a new list with elements in reverse order. Read from input (one value per line or space-separated based on standard convention) and print the result.",
        "concept_tag": "arrays",
        "difficulty_level": "medium",
        "hint_text": "Use list slicing or the reverse method.",
        "solution_code": "import ast\n\narr = ast.literal_eval(input())\nprint(arr[::-1])",
        "solution_explanation": "ast.literal_eval(input()) safely parses the input array from standard input, and arr[::-1] creates a reversed copy which is printed to stdout.",
        "test_cases": [
            {
                "input": "[1, 2, 3]",
    ...
    {
        "title": "Move Zeroes",
        "description": "Given an array, move all 0's to the end while maintaining the relative order of non-zero elements. Read from input (one value per line or space-separated based on standard convention) and print the result.",
        "concept_tag": "arrays",
        "difficulty_level": "medium",
