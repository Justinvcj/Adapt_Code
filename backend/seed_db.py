PROBLEMS = [
    ...
    },
    {
        ...
        "test_cases": [
            ...
            {"input": "[4, 4, 4, 5, 5, 5, 5], 1", "expected_output": "[5]"}
        ]
    },
    {
    ...
    },
    {
        ...
        "test_cases": [
            ...
            {"input": "'abca'", "expected_output": "True"},
    ...
    # --- sliding_window ---
    {
        ...
        "test_cases": [
            {"input": "[1,12,-5,-6,50,3], 4", "expected_output": "12.75"},
            {"input": "[5], 1", "expected_output": "5.0"},
            {"input": "[-1], 1", "expected_output": "-1.0"}
        ]
    },
    {
        ...
        "test_cases": [
            {"input": "[1,2,3,1], 3", "expected_output": "True"},
            {"input": "[1,0,1,1], 1", "expected_output": "True"},
            {"input": "[1,2,3,1,2,3], 2", "expected_output": "False"}
        ]
    },
    {
    ...
    },
    {
        ...
        "test_cases": [
            {"input": "2.0, 10", "expected_output": "1024.0"},
            {"input": "2.1, 3", "expected_output": "9.261000000000001"},
            {"input": "2.0, -2", "expected_output": "0.25"}
        ]
    },
    {
    ...
    # --- backtracking ---
    {
        ...
        "test_cases": [
            {"input": "[1, 2]", "expected_output": "[[], [1], [1, 2], [2]]"},
            {"input": "[0]", "expected_output": "[[], [0]]"},
            {"input": "[]", "expected_output": "[[]]"}
        ]
    },
    {
        ...
        "test_cases": [
            {"input": "[1, 2]", "expected_output": "[[1, 2], [2, 1]]"},
    ...
    },
    {
        ...
        "test_cases": [
            ...
            {"input": "1, 1", "expected_output": "[[1]]"},
            {"input": "3, 3", "expected_output": "[[1, 2, 3]]"}
        ]
    },
    {
    ...
    },
    {
        ...
        "test_cases": [
            ...
            {"input": "[1,3,5,6], 2", "expected_output": "1"},
    ...
    # --- trees ---
    {
        ...
        "test_cases": [
            {"input": "[3, [9, None, None], [20, [15, None, None], [7, None, None]]]", "expected_output": "3"},
            {"input": "[1, None, [2, None, None]]", "expected_output": "2"},
    ...
    },
    {
        ...
        "test_cases": [
            {"input": "[2, [1, None, None], [3, None, None]]", "expected_output": "[2, [3, None, None], [1, None, None]]"},
            {"input": "None", "expected_output": "None"},
            {"input": "[1, [2, None, None], None]", "expected_output": "[1, None, [2, None, None]]"}
        ]
    },
    {
        "title": "Same Tree",
        ...
        "test_cases": [
            {"input": "[1,[2,None,None],[3,None,None]], [1,[2,None,None],[3,None,None]]", "expected_output": "True"},
            {"input": "[1,[2,None,None],None], [1,None,[2,None,None]]", "expected_output": "False"},
            {"input": "None, None", "expected_output": "True"}
        ]
    },
    {
        ...
        "test_cases": [
            {"input": "[2, [1, None, None], [3, None, None]]", "expected_output": "True"},
            {"input": "[5, [1, None, None], [4, [3, None, None], [6, None, None]]]", "expected_output": "False"},
            {"input": "[0, None, None]", "expected_output": "True"}
        ]
    },
    {
        ...
        "test_cases": [
            {"input": "[1, [2, None, None], [3, None, None]]", "expected_output": "[1, [2, None, None], [3, None, None]]"},
            {"input": "None", "expected_output": "None"},
            {"input": "[1, None, None]", "expected_output": "[1, None, None]"}
        ]
    },
    # --- dynamic_programming ---
    {
